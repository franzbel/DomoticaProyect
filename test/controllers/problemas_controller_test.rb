...
class ProblemasControllerTest < ActionController::TestCase
  ...
  test "should create problema" do
    assert_difference('Problema.count') do
      post :create, problema: { description: @problema.description, resolution: @problema.resolution, status: @problema.status, thermostat_id: @problema.thermostat_id }
    end
  ...
  test "should update problema" do
    patch :update, id: @problema, problema: { description: @problema.description, resolution: @problema.resolution, status: @problema.status, thermostat_id: @problema.thermostat_id }
    assert_redirected_to problema_path(assigns(:problema))
  end
